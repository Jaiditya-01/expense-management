        ...
        <div>
          ...
          <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <div className="text-xs text-blue-800 space-y-1">
              <div><strong>Admin:</strong> admin@expense.com / password123</div>
              <div><strong>Manager:</strong> manager@expense.com / password123</div>
              <div><strong>Employee:</strong> employee@expense.com / password123</div>
            </div>
          </div>
        </div>
